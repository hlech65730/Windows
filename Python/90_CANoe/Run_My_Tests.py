...
app.Load('D:\\Canoe\\V2.0_MOPF_02July2019\\VW MQB19 CANoe Simulation\\VW MQB19 CANoe Simulation_no_BAP_HoLe_Smoke_Test_Autom_remote.cfg')

#('C:\\Users\\Public\\Documents\\Vector\\CANoe\\10.0 (x64)\\CANoe Sample Configurations\\Programming\\Python\\CANoeConfig\\PythonBasicEmpty.cfg')

# add test modules to the configuration
app.LoadTestSetup('D:\\Canoe\\V2.0_MOPF_02July2019\\VW MQB19 CANoe Simulation\\TestModules\\Test_Smoke_Automatisierung\\VW_MQB_19_Smoke_Test_Automation.tse')

#('C:\\Users\\Public\\Documents\\Vector\\CANoe\\10.0 (x64)\\CANoe Sample Configurations\\Programming\\Python\\CANoeConfig\\TestEnvironments\\Test Environment.tse')

# add a test configuration and a list of test units
app.LoadTestConfiguration('C:\\Users\\Public\\Documents\\Vector\\CANoe\\10.0 (x64)\\CANoe Sample Configurations\\Programming\\Python\\CANoeConfig\\TestConfiguration', ['TestConfiguration\\EasyTest\\EasyTest.vtuexe'])

#('C:\\Users\\Public\\Documents\\Vector\\CANoe\\10.0 (x64)\\CANoe Sample Configurations\\Programming\\Python\\CANoeConfig\\TestConfiguration', ['TestConfiguration\\EasyTest\\EasyTest.vtuexe'])
